...
new_links.searchDirectoryAPI = function (searchVal) {
    return $.ajax({
        type: "GET",
        url: "https://demo-fi.personium.io/directory/app-uc-directory/OData/directory?$filter=substringof%28%27" + searchVal + "%27%2CalternateName%29+or+substringof%28%27" + searchVal + "%27%2Curl%29",
        datatype: "json",
        headers: {
