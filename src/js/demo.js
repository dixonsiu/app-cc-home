...
demo.initTarget = function() {
  ...
  $('#modal-input-cell').on('hidden.bs.modal', function() {
     if (demoSession && demoSession.demoend) {
          ...
          location.href ="https://demo-fi.personium.io/HomeApplication/__/box-resources/login.html?mode=global";
     };
  ...
  $("#gLogin").on("click", function(e) {
     //var url = "https://accounts.google.com/o/oauth2/v2/auth?client_id=102363313215-408im4hc7mtsgrda4ratkro2thn58bcd.apps.googleusercontent.com&response_type=code+id_token&scope=openid%20email%20profile&redirect_uri=https%3A%2F%2Fdemo-fi.personium.io%2FoidcTest%2Foidc%2Fdav%2Findex2.html&state=abc&display=popup&nonce=personium";
...
demo.createProfileHeaderMenu = function() {
    ...
    html += '<img src="https://demo-fi.personium.io/HomeApplication/__/icons/ico_menu.png">';
    html += '</a>';
