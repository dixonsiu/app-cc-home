...
account.dispAccountList = function (json) {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        var type = acc.Type;
        var typeImgTag = '<img class="image-circle-small-border-less" src="https://demo-fi.personium.io/app-cc-home/__/html/img/type_p.png">';
        if (type !== "basic") {
            typeImgTag = '<img class="image-circle-small-border-less" src="https://demo-fi.personium.io/app-cc-home/__/html/img/type_g.png">';
        }
        html = '<li>';
